...
export default function SearchComponent (): JSX.Element {
    ...
    let partners = useSelector((state: any) => state.partners);
    ...
    function searchLocalUser (name: any) {
        ...
        if (name !== "") {
            ...
            filterByName = filterByName.filter((n: any) => n.name.toLowerCase().includes(name.toLowerCase()))
    ...
    return (
        <div id = "main-box-search-nano" className={style.containerSearch}>
            ...
            <div id = "div-list-nano" className={style.divListNano} >
                ...
                { focus && searchResult ? searchResult.map ((g: any) => {
                    return (
